...
- (void)viewDidLoad {
    ...
    [self.OfflineTableView registerNib:nib forCellReuseIdentifier:@"AQCellViewId"];
...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    self.view.backgroundColor = self.OfflineTableView.backgroundColor = self.OfflineTableView.pullToRefreshView.backgroundColor = [ThemeColors greyBackgroundColor];
